...
```{r smoo01,error=FALSE,warning=FALSE,message=FALSE}
# Carga de datos
data("airquality")
...
```{r smoo02,error=FALSE,warning=FALSE,message=FALSE}
ggplot(datacomp) +
  geom_jitter(aes(value,Ozone, colour=variable),) + 
...
```{r smoo03,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo04,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo05, echo=FALSE,error=FALSE,warning=FALSE,message=FALSE}
ggplot(plantas, aes(x = Densidad, y = Produccion, colour = Localidad)) +
  geom_point() +
...
```{r smoo06,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo07,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo08, echo=FALSE,error=FALSE,warning=FALSE,message=FALSE}
ggplot(infiltracion, aes(x = profundidad, y = cargahid, colour = tratamiento)) +
  geom_point() +
  geom_smooth(method = loess, se = FALSE) +
  labs(x = "Profundidad", y = "Carga Hidráulica")
...
```{r smoo09,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo10,error=FALSE,warning=FALSE,message=FALSE}
summary(fit1.solarr)
```
...
```{r smoo11,error=FALSE,warning=FALSE,message=FALSE}
summary(fit2.solarr)
```
...
```{r smoo12,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo13, echo=FALSE,error=FALSE,warning=FALSE,message=FALSE}
plot_model(fit1.solarr, "pred",
           show.data = TRUE, 
           ci.lvl = NA, 
           title = "Modelo Polinómico")
plot_model(fit2.solarr, "pred",
           show.data = TRUE, 
           ci.lvl = NA, 
...
```{r smoo14,error=FALSE,warning=FALSE,message=FALSE}
# M1: modelo polinómico
...
```{r smoo15,error=FALSE,warning=FALSE,message=FALSE}
summary(fit1.wind)
```
...
```{r smoo16,error=FALSE,warning=FALSE,message=FALSE}
summary(fit2.wind)
```
...
```{r smoo17,error=FALSE,warning=FALSE,message=FALSE}
# Bondad de ajuste de cada modelo (AIC)
g1 <- glance(fit1.wind)
g2 <- glance(fit2.wind)
as_tibble(rbind(g1,g2))
...
```{r smoo18, echo=FALSE,error=FALSE,warning=FALSE,message=FALSE}
plot_model(fit1.wind,"pred",
           show.data = TRUE, 
           ci.lvl = NA, 
           title = "Modelo Polinómico")
plot_model(fit2.wind,"pred",
           show.data = TRUE, 
           ci.lvl = NA, 
           title = "Modelo Suavizado")
```
...
```{r smoo19,error=FALSE,warning=FALSE,message=FALSE}
# M1: modelo polinómico
...
```{r smoo20,error=FALSE,warning=FALSE,message=FALSE}
summary(fit1.temp)
```
...
```{r smoo21,error=FALSE,warning=FALSE,message=FALSE}
summary(fit2.temp)
```
...
```{r smoo22,error=FALSE,warning=FALSE,message=FALSE}
# Bondad de ajuste de cada modelo (AIC)
g1 <- glance(fit1.temp)
g2 <- glance(fit2.temp)
as_tibble(rbind(g1,g2))
...
```{r smoo23, echo=FALSE,error=FALSE,warning=FALSE,message=FALSE}
plot_model(fit1.temp, "pred",
           show.data = TRUE, 
           ci.lvl = NA, 
           title = "Modelo Polinómico")
plot_model(fit2.temp, "pred",
           show.data = TRUE, 
           ci.lvl = NA, 
           title = "Modelo Suavizado")
```
...
```{r smoo24,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo25,error=FALSE,warning=FALSE,message=FALSE}
# Bondad de ajuste de cada modelo (AIC)
g1 <- glance(fit.M1)
g2 <- glance(fit.M2)
g3 <- glance(fit.M3)
...
```{r smoo26,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo27,error=FALSE,warning=FALSE,message=FALSE}
# Bondad de ajuste de cada modelo (AIC)
glance(fit.M9)
```
...
```{r smoo28,error=FALSE,warning=FALSE,message=FALSE}
summary(fit.M8)
```
...
```{r smoo29,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo30, error=FALSE,warning=FALSE,message=FALSE}
ggplot(plantas, aes(x = Densidad, y = Produccion, colour = Localidad)) +
  geom_point() +
  labs(x = "Densidad", y = "Producción")
```
...
```{r smoo31, echo=FALSE,error=FALSE,warning=FALSE,message=FALSE}
fit.plantas.M1 <- gam(Produccion ~ Localidad + Densidad, data = plantas)
plot_model(fit.plantas.M1, "pred", terms = c("Densidad","Localidad"), 
           show.data = TRUE, ci.lvl = FALSE,
           title ="Modelo lineal sin efecto de interacción")
fit.plantas.M2 <- gam(Produccion ~ Localidad * Densidad, data = plantas)
plot_model(fit.plantas.M2, "pred", terms = c("Densidad","Localidad"), 
           show.data = TRUE, ci.lvl = FALSE,
           title ="Modelo lineal con efecto de interacción")
fit.plantas.M3 <- gam(Produccion ~ Localidad + Densidad + I(Densidad^2), 
                      data = plantas)
plot_model(fit.plantas.M3, "pred", terms = c("Densidad","Localidad"), 
           show.data = TRUE, ci.lvl = FALSE,
           title ="Modelo polinómico de grado 2 sin interacción")
fit.plantas.M4 <- gam(Produccion ~ Localidad * (Densidad + I(Densidad^2)), 
                      data = plantas)
plot_model(fit.plantas.M4, "pred", terms = c("Densidad","Localidad"), 
           show.data = TRUE, ci.lvl = FALSE,
           title ="Modelo polinómico de grado 2 con interacción")
fit.plantas.M5 <- gam(Produccion ~ Localidad + s(Densidad, k = 10, m = 2, bs = "ps"),
                      data = plantas)
plot_model(fit.plantas.M5, "pred", terms = c("Densidad","Localidad"), 
           show.data = TRUE, ci.lvl = FALSE,
           title ="Modelo suavizado sin interacción")
fit.plantas.M6 <- gam(Produccion ~ Localidad + 
                      s(Densidad, k = 10, m = 2, bs = "ps", by = Localidad),
                      data = plantas)
plot_model(fit.plantas.M6, "pred", terms = c("Densidad", "Localidad"), 
           show.data = TRUE, ci.lvl = FALSE,
...
```{r smoo32, error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo33, error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo34,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo35,error=FALSE,warning=FALSE,message=FALSE}
gam.check(fit.M10)
```
...
```{r smoo36,error=FALSE,warning=FALSE,message=FALSE}
# Modelo
...
```{r smoo37,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo38,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo39,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo40,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo41,echo=FALSE,error=FALSE,warning=FALSE,message=FALSE}
plot_model(fit.plantas.M6, "pred", terms = c("Densidad", "Localidad"), 
           show.data = TRUE,
           title ="Predicción media de producción")
```
...
```{r smoo42,echo=FALSE,error=FALSE,warning=FALSE,message=FALSE}
plot_model(fit.cargahid, "pred", terms = c("profundidad", "tratamiento"), 
           show.data = TRUE,
           title ="Predicción media de carga hidráulica")
```
...
```{r smoo43,error=FALSE,warning=FALSE,message=FALSE}
# Lectura de datos
...
```{r smoo44,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo45,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo46,error=FALSE,warning=FALSE,message=FALSE}
data("lakemary")
ejer04 <-lakemary
```
...
```{r smoo47,error=FALSE,warning=FALSE,message=FALSE}
...
```{r smoo48,error=FALSE,warning=FALSE,message=FALSE}
