...
```{r aov001,error=FALSE,warning=FALSE,message=FALSE}
# Ajuste del modelo
...
```{r aov002,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov002b,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov003,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov003a,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov003b,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov004,error=FALSE,warning=FALSE,message=FALSE}
# Ajuste del modelo
...
```{r aov005,error=FALSE,warning=FALSE,message=FALSE}
# Modelo sin interceptación
...
```{r aov005b,error=FALSE,warning=FALSE,message=FALSE}
plot_model(m1, show.values = TRUE, vline.color = "yellow")
```
...
```{r aov006,error=FALSE,warning=FALSE,message=FALSE}
glance(fit.envasado)
```

Realizamos las comparaciones múltiples para comparar todas las máquinas dos a dos.

```{r aov006b,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov006c,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov007,error=FALSE,warning=FALSE,message=FALSE}
# Ajuste del modelo
...
```{r aov008,error=FALSE,warning=FALSE,message=FALSE}
# Objeto gráfico
...
```{r aov009,error=FALSE,warning=FALSE,message=FALSE}
glance(fit.venenos)
```
...
```{r aov016,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov017,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov018,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov019,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov021,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov021b,error=FALSE,warning=FALSE,message=FALSE}
# Tests de normalidad
...
```{r aov021c,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov021d,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov027,error=FALSE,warning=FALSE,message=FALSE}
# Valores de diagnóstico
...
```{r aov028,error=FALSE,warning=FALSE,message=FALSE}
# Modelo
...
```{r aov028b,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov030,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov031,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov032,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov032-2,error=FALSE,warning=FALSE,message=FALSE}
# Valores de diagnóstico
...
```{r aov033,error=FALSE,warning=FALSE,message=FALSE}
# Objeto gráfico
...
```{r aov033b,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov034,error=FALSE,warning=FALSE,message=FALSE}
# Objeto gráfico
...
```{r aov035,error=FALSE,warning=FALSE,message=FALSE}
# Objeto gráfico
...
```{r aov035b,error=FALSE,warning=FALSE,message=FALSE}
# Gráfico de interacción estimado
p
```
...
```{r aov035c,error=FALSE,warning=FALSE,message=FALSE}
...
```{r aov035d,error=FALSE,warning=FALSE,message=FALSE}
