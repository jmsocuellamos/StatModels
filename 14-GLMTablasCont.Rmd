...
```{r tcont003, error=FALSE,warning=FALSE,message=FALSE}
# Carga de datos
...
```{r tcont007,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont008,error=FALSE,warning=FALSE,message=FALSE}
# Ajuste del modelo sin interacción
...
```{r tcont009,error=FALSE,warning=FALSE,message=FALSE}
# Ajuste del modelo sin interacción
...
```{r tcont010,error=FALSE,warning=FALSE,message=FALSE}
# Ajuste del modelo sin interacción
...
Podemos cargar los datos y representarlos gráficamente 
```{r tcont011,error=FALSE,warning=FALSE,message=FALSE}
# Ajuste del modelo sin interacción
...
```{r tcont012,error=FALSE,warning=FALSE,message=FALSE}
# Ajuste del modelo sin interacción
...
```{r tcont013,eval = FALSE, error=FALSE,warning=FALSE,message=FALSE}
# Modelo 1
...
```{r tcont014,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont015,error=FALSE,warning=FALSE,message=FALSE}
# Ajuste del modelo sin interacción
fit.aspirina <- glm(frecuencia ~ (locali + ulcera + aspirina)^2, 
              family = poisson(), 
              data = Aspirina)
...
```{r tcont016,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont017,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont018,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont019,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont020,error=FALSE,warning=FALSE,message=FALSE}
# Creamos variable con valores de referencia y obtenemos los log-odds asociados
...
```{r tcont021,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont022,error=FALSE,warning=FALSE,message=FALSE}
# Ajuste del modelo sin interacción triple
...
```{r tcont023,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont024,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont025,error=FALSE,warning=FALSE,message=FALSE}
# Filas de la tabla de estimaciones relacionados con metodo
tabla[6:8,]
```
...
```{r tcont026,error=FALSE,warning=FALSE,message=FALSE}
# Calculamos los conteos predichos del modelo
...
```{r tcont027,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont028,error=FALSE,warning=FALSE,message=FALSE}
# Creamos variable con valores de referencia y obtenemos los log-odds asociados
...
```{r tcont029,error=FALSE,warning=FALSE,message=FALSE}
# Ajuste del modelo sin interacción
...
```{r tcont030,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont031,error=FALSE,warning=FALSE,message=FALSE}
...
Obtenemos la tabla de estimación para el modelo: 
```{r tcont032,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont033,error=FALSE,warning=FALSE,message=FALSE}
# Filas de la tabla de estimaciones relacionados con metodo
tabla[8:13,]
```
...
```{r tcont034,error=FALSE,warning=FALSE,message=FALSE}
# Secuencia de edad
edadsec <- seq(15,49,1)
...
```{r tcont035,error=FALSE,warning=FALSE,message=FALSE}
# Calculamos los conteos predichos del modelo
...
```{r tcont036,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont038,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont039,error=FALSE,warning=FALSE,message=FALSE}
...
Obtenemos la tabla de estimación para el modelo: 
```{r tcont040,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont041,error=FALSE,warning=FALSE,message=FALSE}
# Filas de la tabla de estimaciones relacionados con metodo
tabla[3:5,]
```
...
```{r tcont042,error=FALSE,warning=FALSE,message=FALSE}
# Calculamos los conteos predichos del modelo
...
```{r tcont043,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont045,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont046,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont047,error=FALSE,warning=FALSE,message=FALSE}
# Filas de la tabla de estimaciones relacionados con metodo
tabla[5:8,]
```
...
```{r tcont048,error=FALSE,warning=FALSE,message=FALSE}
# Calculamos los conteos predichos del modelo
...
```{r tcont049,error=FALSE,warning=FALSE,message=FALSE}
ords <- c("< 6000", "6000 - 15000", "15000 - 25000", "> 25000")
...
```{r tcont050,error=FALSE,warning=FALSE,message=FALSE}
...
```{r tcont051,error=FALSE,warning=FALSE,message=FALSE}
# Valores predichos
Aspirina <- Aspirina %>% 
...
```{r tcont052,error=FALSE,warning=FALSE,message=FALSE}
# Valores de diganóstico
...
```{r tcont053,error=FALSE,warning=FALSE,message=FALSE}
# Valores predichos
Aspiraciones <- Aspiraciones %>% 
...
```{r tcont054,error=FALSE,warning=FALSE,message=FALSE}
# Valores de diganóstico
...
```{r tcont055,error=FALSE,warning=FALSE,message=FALSE}
# Valores predichos
Contraceptivos <- Contraceptivos %>% 
...
```{r tcont056,error=FALSE,warning=FALSE,message=FALSE}
# Valores de diganóstico
...
```{r tcont057,error=FALSE,warning=FALSE,message=FALSE}
# Valores predichos
Gripe <- Gripe %>% 
...
```{r tcont058,error=FALSE,warning=FALSE,message=FALSE}
# Valores de diganóstico
...
```{r tcont059,error=FALSE,warning=FALSE,message=FALSE}
# Valores predichos
Satisfaccion <- Satisfaccion %>% 
