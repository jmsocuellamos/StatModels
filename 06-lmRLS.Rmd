...
```{r rls001,error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Gráfico de dispersión de pérdida de peso vs contenido en hierro."}
...
```{r rls002,error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Gráfico de dispersión de resistencia del papel vs concentración de madera."}
...
```{r rls002-1,error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Gráfico de dispersión de viscosidad vs cantidad de aceite."}
...
```{r rls006, error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Ajuste máximo verosímil para los datos de corrosión."}
# Ajuste del modelo
...
```{r rls005, error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Ajuste de mínimos cuadrados para los datos de corrosión."}
# Gráfico del ajuste
...
```{r rls007, error=FALSE,warning=FALSE,message=FALSE}
# Ajuste del modelo
fit <- lm(peso ~ hierro, data = corrosion)
glm_coef(fit)
```
...
```{r rls008, error=FALSE,warning=FALSE,message=FALSE}
...
```{r rls009,error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Gráfico de residuos estandarizados vs valores ajustados."}
...
```{r rls010,error=FALSE,warning=FALSE,message=FALSE}
# Test de diagnóstico
bptest(fit)
```
...
```{r rls011, ,error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Gráfico de normalidad de los residuos estandarizados."}
# grafico qq
...
```{r rls012, ,error=FALSE,warning=FALSE,message=FALSE}
# Test de diagnóstico
...
```{r rls013, ,error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Gráfico de autocorrelación de los residuos estandarizados."}
...
```{r rls014, ,error=FALSE,warning=FALSE,message=FALSE}
# Test de diagnóstico
...
```{r rls015, error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Ajuste para los datos de resitencia del papel"}
# Ajuste del modelo
...
```{r rls016, error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Gráfico de residuos vs ajustados para el modelo de papel"}
...
```{r rls017,error=FALSE,warning=FALSE,message=FALSE}
...
```{r rls018, error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Ajuste para los datos de viscosidad"}
# Ajuste del modelo
...
```{r rls020, error=FALSE,warning=FALSE,message=FALSE}
glance(fit.aceite)
```
...
```{r rls021, error=FALSE,warning=FALSE,message=FALSE}
...
```{r rls022, error=FALSE,warning=FALSE,message=FALSE}
# Varianza constante
bptest(fit.aceite)  
# Normalidad
...
```{r rls023, error=FALSE,warning=FALSE,message=FALSE}
boxcox(fit.aceite)
```
...
```{r rls024, error=FALSE,warning=FALSE,message=FALSE}
...
```{r rls026, error=FALSE,warning=FALSE,message=FALSE}
glance(fit.aceite2)
```
...
```{r rls027, error=FALSE,warning=FALSE,message=FALSE}
...
```{r rls028, error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Gráfico de autocorrelación de los residuos estandarizados."}
...
```{r rls029, error=FALSE,warning=FALSE,message=FALSE}
...
```{r rls030, error=FALSE,warning=FALSE,message=FALSE}
# cargamos datos de predicción
newpred <- data.frame(hierro = c(0.5, 1, 0.5))
...
```{r rls031, error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Predicción para los datos de corrosión (media e IC95%)."}
# Gráfico del ajuste
plot_model(fit, "pred", terms = ~hierro, 
                ci.lvl = 0.95, 
                show.data = TRUE, 
...
```{r rls032, error=FALSE,warning=FALSE,message=FALSE}
# cargamos datos de predicción
...
```{r rls033, error=FALSE,warning=FALSE,message=FALSE}
...
```{r rls034, error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Predicción para los datos de log(viscosidad) (media e IC95%)."}
# Gráfico del ajuste
plot_model(fit.aceite2, "pred", terms = ~aceite, 
                ci.lvl = 0.95, 
                show.data = TRUE, 
...
```{r rls035, error=FALSE,warning=FALSE,message=FALSE, fig.cap = "Predicción para los datos de viscosidad (media e IC95%)."}
