...
```{r, echo = FALSE}
M0 <- lm(vida ~ velocidad + herramienta + velocidad:herramienta, data = tiempovida)
plot_model(M0, "pred", terms = c("velocidad","herramienta"), 
           show.data = TRUE,
           ci.lvl = NA, 
...
```{r, echo = FALSE}
M0 <- lm(longevidad ~ thorax + actividad + thorax:actividad, data = longevidad)
plot_model(M0, "pred", terms = c("thorax","actividad"), 
           show.data = TRUE,
           ci.lvl = NA, 
           title = "Rectas perpendiculares")
```
...
```{r, echo = FALSE}
M0 <- lm(vida ~ velocidad + herramienta, data = tiempovida)
plot_model(M0, "pred", terms = c("velocidad","herramienta"), 
           show.data = TRUE,
           ci.lvl = NA, 
...
```{r, echo = FALSE}
M0 <- lm(longevidad ~ thorax + actividad, data = longevidad)
plot_model(M0, "pred", terms = c("thorax","actividad"), 
           show.data = TRUE,
           ci.lvl = NA, 
           title = "Rectas paralelas")
...
plot_model(M0, "pred", terms = "velocidad", 
           show.data = TRUE,
           ci.lvl = NA, 
           title = "Recta de regresión lineal simple")
```
...
plot_model(M0, "pred", terms = "thorax", 
           show.data = TRUE,
           ci.lvl = NA, 
           title = "Recta de regresión lineal simple")
```
...
```{r, echo = FALSE}
M0 <- lm(vida ~ herramienta, data = tiempovida)
plot_model(M0, "pred", terms = "herramienta", 
           show.data = TRUE,
           ci.lvl = NA, 
...
```{r, echo = FALSE}
M0 <- lm(longevidad ~ actividad, data = longevidad)
plot_model(M0, "pred", terms = "actividad", 
           show.data = TRUE,
           ci.lvl = NA, 
           title = "ANOVA de una vía")
```
...
```{r ancov001,echo=TRUE,error=FALSE,warning=FALSE,message=FALSE}
# Modelo saturado
...
```{r ancov002,echo=TRUE,error=FALSE,warning=FALSE,message=FALSE}
# Modelo saturado
fit.vida <- lm(vida ~ velocidad + herramienta, data = tiempovida)
...
```{r ancov003,echo=TRUE,error=FALSE,warning=FALSE,message=FALSE}
# Modelos
...
```{r ancov004,echo=TRUE,error=FALSE,warning=FALSE,message=FALSE}
# Modelos
fit.longevidad <- lm(longevidad ~ thorax + actividad, data = longevidad)
# Parámetros estimados
...
```{r ancov005,error=TRUE,warning=FALSE,message=FALSE}
...
```{r ancov005b,error=TRUE,warning=FALSE,message=FALSE}
# Tests de hipótesis
...
```{r ancov005c,error=TRUE,warning=FALSE,message=FALSE}
...
```{r ancov006,error=TRUE,warning=FALSE,message=FALSE}
# Valores de diagnóstico
...
```{r ancov006b,error=TRUE,warning=FALSE,message=FALSE}
# Tests de hipótesis
...
```{r ancov007,error=TRUE,warning=FALSE,message=FALSE}
...
```{r ancov008,error=TRUE,warning=FALSE,message=FALSE}
# Transformación
...
```{r ancov009,echo=TRUE,error=FALSE,warning=FALSE,message=FALSE}
# Modelos
fit.longevidad <- lm(rlongevidad ~ thorax + actividad, data = longevidad)
# Parámetros estimados
tab_model(fit.longevidad,
...
```{r ancov010,error=FALSE,warning=FALSE,message=FALSE}
# Valores de diagnóstico
diagnostico <- fortify(fit.longevidad)
# Gráfico
ggplot(diagnostico,aes(x = thorax, y = .stdresid, colour = actividad)) + 
...
```{r ancov011,error=FALSE,warning=FALSE,message=FALSE}
...
```{r ancov012,error=FALSE,warning=FALSE,message=FALSE}
...
```{r ancov012b,error=FALSE,warning=FALSE,message=FALSE}
