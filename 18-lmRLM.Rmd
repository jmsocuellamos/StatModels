...
```{r rlm001, error=FALSE, warning=FALSE, message=FALSE, fig.cap = "Gráfico de dispersión de Volumen respecto de cada predictora."}
...
```{r rlm002, error=FALSE, warning=FALSE, message=FALSE, fig.cap = "Gráfico de dispersión de la concentración del fármaco respecto de cada predictora."}
...
```{r rlm003, error=FALSE, warning=FALSE, message=FALSE, fig.cap = "Gráfico de dispersión de resistencia del papel vs concentración de madera."}
...
```{r rlm0031, error=FALSE, warning=FALSE, message=FALSE}
# Ajuste del modelo
...
```{r rlm004, error=FALSE, warning=FALSE, message=FALSE}
# Gráfico del ajuste
...
```{r rlm005, error=FALSE, warning=FALSE, message=FALSE}
# Inferencia sobre los parámetros del modelo
...
```{r rlm005-2, error=FALSE, warning=FALSE, message=FALSE}
# Gráfico del ajuste
plot_model(fit.bosque, 
        show.values = TRUE, 
        vline.color = "yellow", 
...
```{r rlm006, error=FALSE, warning=FALSE, message=FALSE}
# Gráfico del ajuste
...
```{r rlm007, error=FALSE, warning=FALSE, message=FALSE}
# Ajuste del modelo
...
```{r rlm008, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm010, error=FALSE, warning=FALSE, message=FALSE}
# Ajuste del modelo
...
```{r rlm011, error=FALSE, warning=FALSE, message=FALSE}
# Gráfico del ajuste sin estandarizar
...
```{r rlm012, error=FALSE, warning=FALSE, message=FALSE}
# Gráfico del ajuste
...
```{r rlm013, error=FALSE, warning=FALSE, message=FALSE}
# Bondad del ajuste
glance(fit.bosque)
# Tabla ANOVA
anova(fit.bosque)
...
```{r rlm014, error=FALSE, warning=FALSE, message=FALSE}
# Bondad del ajuste
glance(fit.concen)
# Tabla ANOVA
anova(fit.concen)
...
```{r rlm015, error=FALSE, warning=FALSE, message=FALSE}
# Bondad del ajuste
glance(fit.papel)
# Tabla ANOVA
anova(fit.papel)
...
```{r rlm016, error=FALSE, warning=FALSE, message=FALSE}
# Modelo saturado
...
```{r rlm017, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm018, error=FALSE, warning=FALSE, message=FALSE}
g2 <- glance(M2)
g1 <- glance(M1)
...
```{r rlm019, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm019-1, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm019-2, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm020, error=FALSE, warning=FALSE, message=FALSE}
# Modelo seleccionado
...
```{r rlm021, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm022, error=FALSE, warning=FALSE, message=FALSE}
# Modelo saturado
...
```{r rlm023, error=FALSE, warning=FALSE, message=FALSE}
# Comparativa de modelos
tab_model(M1, M2, show.ci = FALSE)
```
...
```{r rlm023-1, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm024, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm025, error=FALSE, warning=FALSE, message=FALSE}
# Modelo saturado
...
```{r rlm026, error=FALSE, warning=FALSE, message=FALSE}
# Comparativa de modelos
tab_model(M1, M2, show.ci = FALSE)
```
...
Utilizamos ahora las funciones específicas:
```{r rlm026-1, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm027, error=FALSE, warning=FALSE, message=FALSE}
# Modelos
fit.bosque<- lm(vol ~ d16 + ht, data = bosque)
...
```{r rlm028, error=FALSE, warning=FALSE, message=FALSE}
# Modelos
fit.concen<- lm(concen ~ p.cuerpo + p.higado + dosis, data = concentracion)
# Análisis de multicolinealidad
...
```{r rlm029, error=FALSE, warning=FALSE, message=FALSE}
# Modelos
fit.concen<- lm(concen ~ p.cuerpo + dosis, data = concentracion)
# Análisis de multicolinealidad
ols_coll_diag(fit.concen)
...
```{r rlm030, error=FALSE, warning=FALSE, message=FALSE}
# Análisis de multicolinealidad
...
```{r rlm031, error=FALSE, warning=FALSE, message=FALSE}
# Modelos
fit.bosque <- lm(vol ~ d16 + ht, data = bosque)
...
```{r rlm032, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm033, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm034, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm035, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm036, error=FALSE, warning=FALSE, message=FALSE}
# Modelos
fit.concen <- lm(concen ~ p.cuerpo + dosis, data = concentracion)
# Valores de diagnóstico
...
Estudiamos los gráficos de diagnóstico para detectar residuos grandes (gráfico secuencial de residuos), linealidad y homocedasticidad (gráfico de residuos estandarizados versus valores ajustados), y normalidad (gráfico qq).
```{r rlm037, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm038, error=FALSE, warning=FALSE, message=FALSE}
...
Realizamos ahora los tests necesarios para verificar las hipótesis de normalidad, homocedasticidad, e independencia.
```{r rlm039, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm040, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm041, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm042, error=FALSE, warning=FALSE, message=FALSE}
# Modelos
fit.papel <- lm(tension ~ madera + I(madera^2), data = papel)
# Valores de diagnóstico
...
Estudiamos los gráficos de diagnóstico para detectar residuos grandes (gráfico secuencial de residuos), linealidad y homocedasticidad (gráfico de residuos estandarizados versus valores ajustados), y normalidad (gráfico qq).
```{r rlm043, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm044, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm045, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm046, error=FALSE, warning=FALSE, message=FALSE}
...
```{r rlm047, error=FALSE, warning=FALSE, message=FALSE}
# Gráfico del ajuste
plot_model(fit.bosque, "pred", 
        ci.lvl = 0.95, 
        show.data = TRUE, 
...
```{r rlm048, error=FALSE, warning=FALSE, message=FALSE}
# cargamos datos de predicción
...
Veamos ahora las predicciones marginales de cada variable:
```{r rlm049, error=FALSE, warning=FALSE, message=FALSE}
# Gráfico del ajuste
plot_model(fit.papel, "pred", 
        ci.lvl = 0.95, 
        show.data = TRUE, 
